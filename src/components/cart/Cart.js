...
const addressinfo = localStorage.getItem('Address')?JSON.parse(localStorage.getItem('Address')):false
const dat = localStorage.getItem('Coordinates')?JSON.parse(localStorage.getItem('Coordinates')):false
...
<button className='paybtn' onClick={()=>navigate('/addadress')}>Add more details</button>
    </div>:<><div

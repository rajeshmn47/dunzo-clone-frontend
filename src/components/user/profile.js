    ...
    <>
      ...
      <div className="profiletop">
        <div>
          ...
          <h5
            style={{ display: "flex", alignItems: "center", color: "#6F7588" }}
          >
            <MailIcon
              size="small"
              style={{ marginRight: "2vw", fontSize: "14px" }}
            />
        ...
        <div>
          <button className="edit">
            edit <ChevronRightOutlinedIcon htmlColor="#00B37A" />
          </button>
        </div>
      </div>
      <div className="aadhaar">
        ...
        <h6>
          you can verify your age using government ID to order Paan items from
          Dunzo
        </h6>
      </div>
